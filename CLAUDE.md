...
- link an experiment execution action to its concrete preregistered `X###`; draft, completed, and cancelled experiments cannot be presented as the current executable action. Cancelled drafts may remain unregistered when their cancellation timestamp and reason are preserved.
